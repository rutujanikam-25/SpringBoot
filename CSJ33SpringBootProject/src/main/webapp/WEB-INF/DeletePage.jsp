...
<form action="/SpringBoot/DeleteCourse" method="post">
<label for="courseId"></label>
<input type="hidden" value=<%=course.getCourseId() %>>
<br>
<label for="courseName"></label>
<input type="text" value=<%=course.getCourseName() %>>
<br>
<label for="coursePrice"></label>
<input type="text" value=<%=course.getCoursePrice() %>>
<br>
